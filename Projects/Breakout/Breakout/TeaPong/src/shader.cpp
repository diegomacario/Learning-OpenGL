...
Shader::Shader(const char* vShaderFilePath, const char* fShaderFilePath)
{
...
Shader::Shader(const char* vShaderFilePath, const char* fShaderFilePath, const char* gShaderFilePath)
{
   GLuint vShaderID = createAndCompileShader(vShaderFilePath, GL_VERTEX_SHADER);
   GLuint fShaderID = createAndCompileShader(fShaderFilePath, GL_FRAGMENT_SHADER);
...
{
   glUniformMatrix2fv(glGetUniformLocation(shaderProgID, name.c_str()), 1, GL_FALSE, &mat[0][0]);
}

void Shader::setMat3(const std::string &name, const glm::mat3 &mat) const
{
   glUniformMatrix3fv(glGetUniformLocation(shaderProgID, name.c_str()), 1, GL_FALSE, &mat[0][0]);
}

void Shader::setMat4(const std::string &name, const glm::mat4 &mat) const
{
   glUniformMatrix4fv(glGetUniformLocation(shaderProgID, name.c_str()), 1, GL_FALSE, &mat[0][0]);
}

GLuint Shader::createAndCompileShader(const char* shaderFilePath, GLenum shaderType) const
{
...
void Shader::checkForCompilationErrors(GLuint shaderID, GLenum shaderType, const char* shaderFilePath) const
{
   GLint success;
