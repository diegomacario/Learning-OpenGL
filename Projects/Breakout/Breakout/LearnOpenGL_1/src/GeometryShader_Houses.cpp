...
int main()
{
    ...
    // -------------------------
    Shader shader("shader/15.1.geometry_shader_house.vs",
                  "shader/15.1.geometry_shader_house.fs",
                  "shader/15.1.geometry_shader_house.gs");

    // set up vertex data (and buffer(s)) and configure vertex attributes
    // ------------------------------------------------------------------

    // Note that the positions are already in NDC
    float points[] = {
        // Position   // Colour
