...
int main()
{
    ...
    // -------------------------
    Shader shader("shader/8.1.stencil_testing.vs", "shader/8.1.stencil_testing.fs");
    Shader shaderSingleColor("shader/8.1.stencil_testing.vs", "shader/8.2.stencil_single_color.fs");
    ...
    // load textures
    // -------------
    unsigned int cubeTexture  = loadTexture("tex/marble.jpg");
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // while the objects' size differences are, making them look like borders.
        glStencilFunc(GL_NOTEQUAL, 1, 0xFF);
        glStencilMask(0x00);
