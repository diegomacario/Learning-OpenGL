...
int main()
{
   ...
   Shader lightingShader("shader/4.1.lighting_maps.vs", "shader/4.1.lighting_maps.fs");
   Shader lampShader("shader/4.1.lamp.vs", "shader/4.1.lamp.fs");
   ...
   // The loadTexture function does not unbind the texture it loaded, so we do it here
...
// We will replace the diffuse vec3 with a sampler2D vec3
