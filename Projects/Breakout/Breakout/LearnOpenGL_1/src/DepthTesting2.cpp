...
int main()
{
    ...
    // -------------------------
    //Shader shader("../LearnOpenGL_1/shader/7.1.depth_testing.vs", "../LearnOpenGL_1/shader/7.1.depth_testing.fs");
    Shader shader("shader/7.2.depth_testing.vs", "shader/7.2.depth_testing.fs");
