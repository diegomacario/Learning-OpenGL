...
int main()
{
    ...
    // -------------------------
    Shader modelShader("shader/13.5.cubemaps_model_refractive.vs", "shader/13.5.cubemaps_model_refractive.fs");
    ...
    // load model
    Model suitModel("objects/nanosuit/nanosuit.obj");
    ...
    // --------------------
    modelShader.use();
    modelShader.setInt("skybox", 3); // Texture units 0, 1, and 2 are occupied by the model
