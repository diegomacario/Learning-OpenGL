...
int main()
{
    ...
    // -------------------------
    Shader shader("shader/15.2.geometry_shader_model_diffuse.vs",
                  "shader/15.2.geometry_shader_model_diffuse.fs");
    Shader normalShader("shader/15.2.geometry_shader_normal_visualization.vs",
                        "shader/15.2.geometry_shader_normal_visualization.fs",
                        "shader/15.2.geometry_shader_normal_visualization.gs");
